...
from deutschland.bundestag_tagesordnung import rest
...
from deutschland.bundestag_tagesordnung.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.bt_to_csv_get  # this is an instance of the class Endpoint
        api_instance.bt_to_csv_get()  # this invokes api_instance.bt_to_csv_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.bt_to_csv_get.callable or self.callable in this class
